...
class Neuron:
    ...
    def train(
        ...
        Args:
            ...
            alpha: learning rate (default 0.05)
            verbose: bool defining whether to print training info (def. True)
            graph: bool defining whether to graph training info (default True)
            step: steps between verbose output and graph points (default 100)
        ...
        if graph and iterations % step != 0:
            final_cost = self.cost(Y, self.__A)
