...
def marginal(x, n, P, Pr):
    ...
    Marginal probability = P(data) = sum over all p of P(data | p) * P(p)
    This is the total probability of observing the data across all possible
...
def posterior(x, n, P, Pr):
    ...
    # Calculate intersection values (joint probability)
    intersec = intersection(x, n, P, Pr)

    # Calculate marginal probability (evidence)
    marginal_prob = marginal(x, n, P, Pr)

    # Calculate posterior probability using Bayes' theorem
    # P(p | data) = P(data | p) * P(p) / P(data)
    posterior_values = intersec / marginal_prob
